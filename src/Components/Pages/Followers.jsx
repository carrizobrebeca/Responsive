    ...
    return (
     <div className="bg-gray-100 min-h-screen bg-gray-100">
                ...
                <div className="flex items-center gap-4 text-gray-600 py-2 px-4">
                    ...
                    <button className="text text-gray-400 font-bold font-mono bg-gray-300 text-gray-600 rounded-full p-2">Dejar de seguir</button>
                </div>
            </section>    <section className="mt-10 mb-10">
                <div className="flex items-center gap-4 text-gray-600 py-2 px-4">
                    <img
                        src=
                        "https://w7.pngwing.com/pngs/857/213/png-transparent-man-avatar-user-business-avatar-icon.png"
