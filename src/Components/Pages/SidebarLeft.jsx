...
const SidebarLeft = ({
    ...
    return (
        <div className={`fixed bg-bg flex-col items-center ${minimized ? 'w-[4.94rem]' : 'w-[30rem]'} h-[100%] border br-2 border-border py-[1.4rem] px-[1rem] transition-[width] duration-500 ease-in-out`}>
