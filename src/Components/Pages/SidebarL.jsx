    ...
    return (
        ...
        >
            <div className="w-[100%] flex items-center">
                {/* <h2 className="text-gray-100 font-bold font-mono w-[2rem] gap-[0.7rem] pl-[0.455rem] ">E</h2> */}
                <span
                    id="menubtn"
                    ref={menuBtnRef}
                    className="text-[2.1rem] text-text font-bold cursor-pointer overflow-hidden"
                >
                    {minimized ? 'E' : 'Evently'}
                </span>
            </div>
            ...
            <div className='fixed bottom-6 flex items-center'>
                ...
                <h3 className='text-[0.8rem] text-text '> {minimized ? '' : '© 2025 REBECA CARRIZO BOURLOT'} </h3>
            </div>
