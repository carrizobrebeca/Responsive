...
const Comment = () => {
  ...
  return (
    <div className="flex flex-row md:flex-row items-center justify-between gap-4 pt-4 pb-4">
      <form className="w-full p-2 bg-gray-200 rounded-3xl">
        ...
        <div className="flex justify-between p-4">
          ...
          <button className="bg-gray-400 p-2 text-gray-100 rounded-xl">
