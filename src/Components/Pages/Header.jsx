...
const Header = () => {
  ...
  return (
    <header className="flex flex-row md:flex-row items-center justify-between gap-4 pt-6 pb-6">
      ...
      <form className="w-full p-10 bg-gray-200 rounded-3xl">
        <div className="flex justify-between p-4">
          <h2 className="text-xl md:text-3xl text-blue-600 font-bold">
            Crear nuevo evento
          </h2>
          <input className="rounded-full text-lg bg-gray-300 px-4 py-2 w-auto min-w-[500px]" type="text" placeholder="Empecemos un nuevo evento !" />
