...
const SidebarLeft = () => {
    ...
    return (
        <div
            id="sidebar"
            className={`fixed bg-bg flex-col items-center 
                ${minimized ? 'w-[4.94rem]' : 'w-[15rem]'} 
        ...
        >
            ...
            <ul className="w-full flex-col gap-[0.8rem]">
                ...
                <li>
                    <a href="#" onClick={handleToggle} className="flex py-[0.55rem] px-0 rounded-xl hover:bg-header">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
